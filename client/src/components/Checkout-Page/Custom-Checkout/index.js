...
let shipping = {
  name: "shamroz",
  address: "Drottninggatan 26, 736 31 Kungsör",
...
const CustomCheckout = () => {
  ...
  return (
    <div className="grid place-items-center h-screen">
      <div className="container mx-auto p-6 space-y-4  rounded-xl shadow-lg max-w-lg  ">
        {user && cards && cards.length > 0 && (
          <div className="flex gap-3">
            <h4 className="text-md">Pay with saved card</h4>
            <select
              value={payment}
        ...
        {user && (
          <div className="flex gap-3 items-center">
            <label className="text-xl font-semibold">Save Card</label>
            <input
              type="checkbox"
              checked={saveCard}
