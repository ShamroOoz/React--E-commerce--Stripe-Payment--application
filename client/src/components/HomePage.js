    ...
    <>
        ...
        <div className="items-center md:flex">
          <div className="w-full md:w-1/2">
            <div className="md:max-w-md">
              ...
              <button className="w-full px-3 py-2 mt-6 text-xs font-medium text-white uppercase transition-colors duration-200 transform bg-blue-600 rounded-md md:w-auto hover:bg-blue-500 focus:outline-none focus:bg-blue-500">
                Shop Now
              </button>
            </div>
          </div>
      ...
      <section className="py-20 overflow-x-hidden bg-gray-100">
        <div className="container relative px-4 mx-auto">
          <div className="absolute inset-0 my-8 -ml-4 -mr-4 bg-blue-200"></div>
          <div className="relative overflow-hidden bg-blue-300">
            <div className="relative flex flex-wrap items-center">
              <div className="w-full p-10 md:w-4/6 lg:pl-40">
                <span className="text-xl text-white md:text-2xl">
                  New Products
                </span>
                <h2 className="mt-4 text-4xl font-bold text-white mb-14 md:text-5xl font-heading">
                  Check our new collection
                </h2>
                <a
                  className="inline-block px-8 py-4 font-bold text-white uppercase transition duration-200 bg-blue-600 rounded-md hover:bg-blue-400 font-heading"
                  href="/"
                >
                  More
                </a>
              ...
              <img
                className="relative object-cover w-full ml-auto md:w-2/6 h-96"
      ...
      <section className="py-20 bg-gray-100">
        <div className="container px-4 mx-auto">
          <div className="flex flex-wrap pb-20 -mx-4 border-b">
            <div className="relative w-full px-4 mb-16 md:w-1/2 lg:w-1/4 lg:mb-0">
              <img
                className="absolute top-0 hidden ml-16 md:block left-1/2 lg:ml-8"
                src="yofte-assets/elements/dots.svg"
                alt=""
              />
              <div className="relative text-center">
                <span className="inline-flex items-center justify-center w-20 h-20 mb-16 bg-white rounded-full">
                  <svg
                    width="37"
                    height="27"
                    viewBox="0 0 37 27"
            ...
            <div className="relative w-full px-4 mb-16 md:w-1/2 lg:w-1/4 lg:mb-0">
              <img
                className="absolute top-0 hidden ml-8 lg:block left-1/2"
                src="yofte-assets/elements/dots.svg"
                alt=""
              />
              <div className="relative text-center">
